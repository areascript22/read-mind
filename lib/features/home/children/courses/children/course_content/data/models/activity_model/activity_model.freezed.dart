...
@override
String toString() {
  return 'ActivityModel(id: $id, title: $title, description: $description, dueDate: $dueDate, content: $content, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
class AIReadingModel implements ActivityModel {
  const AIReadingModel({required this.id, required this.title, required this.description, required this.dueDate, required this.content, required this.createdAt, required this.updatedAt});
