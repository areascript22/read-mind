...
$MainIdeaAttemptModelCopyWith<MainIdeaAttemptModel> get copyWith => _$MainIdeaAttemptModelCopyWithImpl<MainIdeaAttemptModel>(this as MainIdeaAttemptModel, _$identity);

  /// Serializes this MainIdeaAttemptModel to a JSON map.
...
/// @nodoc
abstract mixin class $MainIdeaAttemptModelCopyWith<$Res>  {
...
/// @nodoc
class _$MainIdeaAttemptModelCopyWithImpl<$Res>
    implements $MainIdeaAttemptModelCopyWith<$Res> {
  _$MainIdeaAttemptModelCopyWithImpl(this._self, this._then);

  final MainIdeaAttemptModel _self;
  final $Res Function(MainIdeaAttemptModel) _then;
...
as double,concisenessScore: null == concisenessScore ? _self.concisenessScore : concisenessScore // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [MainIdeaAttemptModel].
extension MainIdeaAttemptModelPatterns on MainIdeaAttemptModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MainIdeaAttemptModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MainIdeaAttemptModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MainIdeaAttemptModel value)?  $default,){
final _that = this;
switch (_that) {
case _MainIdeaAttemptModel() when $default != null:
return $default(_that);case _:
...
@override final  double concisenessScore;
...
@pragma('vm:prefer-inline')
_$MainIdeaAttemptModelCopyWith<_MainIdeaAttemptModel> get copyWith => __$MainIdeaAttemptModelCopyWithImpl<_MainIdeaAttemptModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MainIdeaAttemptModelToJson(this, );
}
...
/// @nodoc
abstract mixin class _$MainIdeaAttemptModelCopyWith<$Res> implements $MainIdeaAttemptModelCopyWith<$Res> {
...
/// @nodoc
class __$MainIdeaAttemptModelCopyWithImpl<$Res>
    implements _$MainIdeaAttemptModelCopyWith<$Res> {
  __$MainIdeaAttemptModelCopyWithImpl(this._self, this._then);

  final _MainIdeaAttemptModel _self;
  final $Res Function(_MainIdeaAttemptModel) _then;
