...
mixin _$CourseModel {
 ...
 int get id; String get name; String get description; String get inviteCode; int get teacherId; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,inviteCode,teacherId,createdAt);

@override
String toString() {
  return 'CourseModel(id: $id, name: $name, description: $description, inviteCode: $inviteCode, teacherId: $teacherId, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int id, String name, String description, String inviteCode, int teacherId, DateTime createdAt
});
...
/// Create a copy of CourseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = null,Object? inviteCode = null,Object? teacherId = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String description,  String inviteCode,  int teacherId,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CourseModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.inviteCode,_that.teacherId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String description,  String inviteCode,  int teacherId,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _CourseModel():
return $default(_that.id,_that.name,_that.description,_that.inviteCode,_that.teacherId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String description,  String inviteCode,  int teacherId,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _CourseModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.inviteCode,_that.teacherId,_that.createdAt);case _:
  return null;
...
class _CourseModel implements CourseModel {
  const _CourseModel({required this.id, required this.name, required this.description, required this.inviteCode, required this.teacherId, required this.createdAt});
...
/// Create a copy of CourseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? inviteCode = null,Object? teacherId = null,Object? createdAt = null,}) {
